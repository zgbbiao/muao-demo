	...
	<view v-show="show" class="t-wrapper" @touchmove.stop.prevent="moveHandle">
		...
		<view class="t-box" :class="{active:active}">
			...
			<view class="t-color__box" :style="{ background: 'rgb(' + bgcolor.r + ',' + bgcolor.g + ',' + bgcolor.b + ')'}">
				<view class="t-background boxs"  @mousedown.native="touchstart($event, 0, 'mouse')" @touchstart="touchstart($event, 0)"  @mousemove.native="touchmove($event, 0, 'mouse')" @touchmove="touchmove($event, 0)" @touchend="touchend($event, 0)" @mouseup="touchend($event, 0, 'mouse')">
			...
			<view class="t-control__box">
				...
				<view class="t-control-box__item">
					<view class="t-controller boxs" @mousedown.native="touchstart($event, 1, 'mouse')" @touchstart="touchstart($event, 1)" @mousemove.native="touchmove($event,1, 'mouse')" @touchmove="touchmove($event, 1)" @touchend="touchend($event, 1)" @mouseup="touchend($event, 1, 'mouse')">
						<view class="t-hue">
							<view class="t-circle" :style="{ left: site[1].left - 12 + 'px' }"></view>
						</view>
					</view>
					<view class="t-controller boxs" @mousedown.native="touchstart($event, 2, 'mouse')" @touchstart="touchstart($event, 2)" @mousemove.native="touchmove($event,2, 'mouse')" @touchmove="touchmove($event, 2)" @touchend="touchend($event, 2)" @mouseup="touchend($event, 2, 'mouse')">
