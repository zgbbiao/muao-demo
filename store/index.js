...
} from '@/src/common/js/localStore';
import controlPanel from './modules/controlPanel/index.js';
...
const store = new Vuex.Store({
  state: {
    ...
    componentsInfo: {
          ...
          propsValue: [
            ...
            },
            {
              ...
              select: [
                ...
                { label: '密码(拖动有bug)', value: 'password' },
                { label: '身份证输入', value: 'idcard' },
                { label: '带小数点的数字键盘', value: 'digit' },
              ],
              defaultValue: 'text',
            },
            {
          ...
          propsValue: [
            {
              label: '值',
              key: 'value',
              value: '长文本这玩意有bug，无法对文字拖动，只能拖空白处',
              toDataOrHtml: 'html',
              type: 'String',
              defaultValue: '',
            },
        ...
        },
        {
          ...
          propsValue: [
            ...
            },
            {
              ...
              type: 'select',
              select: [
                { label: '不保持纵横比', value: 'scaleToFill' },
                { label: '保持纵横比', value: 'aspectFit' },
                { label: 'aspectFill', value: 'aspectFill' },
                { label: '顶部区域', value: 'top' },
                { label: '底部区域', value: 'bottom' },
                { label: '中间区域', value: 'center' },
                { label: '左边区域', value: 'left' },
                { label: '右边区域', value: 'right' },
              ],
            },
          ],
        },
          ...
          propsValue: [
            {
              label: '类型',
              key: 'class',
              value: 'cuIcon-appreciate',
              toDataOrHtml: 'data',
              type: 'select',
              select: [
                { label: '点赞', value: 'cuIcon-appreciate' },
                { label: '点击', value: 'cuIcon-check' },
                { label: '关闭', value: 'cuIcon-close' },
              ],
            },
          ],
          upxSwitch: false,
      ...
      formList: [
        ...
        },
        {
          name: '时间选择',
          id: 2004,
          componentName: 'FromSelectByTime',
          iStyle: {},
          iClass: [],
          propsValue: [],
          upxSwitch: false,
        },
        {
          name: '日期选择',
          id: 2005,
          componentName: 'FromSelectByDate',
          iStyle: {},
          iClass: [],
          propsValue: [],
          upxSwitch: false,
    ...
    uiChildrenName: 'children', // Ui参数的chileren
  },
  mutations: {
