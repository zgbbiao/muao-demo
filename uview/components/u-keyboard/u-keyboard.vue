<template>
	<u-popup class="" :maskCloseAble="maskCloseAble" mode="bottom" :show="show" length="auto" :safeAreaInsetBottom="safeAreaInsetBottom" @close="popupClose">
		<slot />
		...
		<block v-if="mode == 'number' || mode == 'card'">
			<u-number-keyboard :random="random" @backspace="backspace" @change="change" :mode="mode" :dotEnable="dotEnable"></u-number-keyboard>
		</block>
		<block v-else>
